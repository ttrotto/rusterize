/*
The AllTouched strategy has been adapted from GDAL:
https://github.com/OSGeo/gdal/blob/63396dbf42999441478e036ebb145725de09f7ce/alg/llrasterize.cpp#L407
*/
...
/// Strategy for burning a single [`geo::Linestring`].
/// `all_touched` burns all pixels that are touched by the line.
    ...
    W: PixelWriter<N>,
{
    ...
    while yline < raster_info.nrows && (!active_edges.is_empty() || !polyedges.is_empty()) {
        ...
        // sort by y line
        active_edges.sort_by(|a, b| a.x_at_yline.total_cmp(&b.x_at_yline));
