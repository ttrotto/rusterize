...
/// Spatial coordinates of a single [`geo::Point`].
...
/// Represents the edges of a single [`geo::Polygon`].
...
impl PolyEdge {
    ...
    #[inline]
    pub(crate) fn intersect_at(&self, yline: usize) -> f64 {
        // y line center
...
/// Represent the edges of a single [`geo::Linestring`].
pub(crate) struct LineEdge {
    pub x0: f64,
    pub y0: f64,
    pub x1: f64,
    pub y1: f64,
...
pub(crate) fn extract_point(edges: &mut Vec<PointEdge>, point: &Point<f64>, raster_info: &RasterInfo) {
...
pub(crate) fn extract_ring(edges: &mut Vec<PolyEdge>, line: &LineString<f64>, raster_info: &RasterInfo) {
...
pub(crate) fn extract_line(edges: &mut Vec<LineEdge>, line: &LineString<f64>, raster_info: &RasterInfo) {
    let rows = raster_info.nrows as f64;
